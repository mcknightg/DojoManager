...
//  Dojomanager Student Controller
catwalkApp.controller('DojomanagerStudentController', ['$scope','$location','$stateParams','$global.services', 'DojomanagerStudent',
    function ($scope,location,$stateParams,$services, service) {
        ...
        $scope.new= function(){
            location.path('/dojomanager/student/');
        };

        $scope.update= function(id){
            location.path('/dojomanager/student/' + id);
        };
...
//  Dojomanager Student Routing
catwalkApp.config(['$stateProvider', '$urlRouterProvider','USER_ROLES',
    function ($stateProvider, $urlRouterProvider, USER_ROLES) {
        $stateProvider
        .state('dojomanager.student', {
            url: "/student",
            templateUrl: "components/model/student/studentTable.html",
            controller: 'DojomanagerStudentController',
            access: {
                authorizedRoles: [USER_ROLES.all]
            }
        })
        .state('dojomanager.studentForm', {
            url: "/student/:id",
