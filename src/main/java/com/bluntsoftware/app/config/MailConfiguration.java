...
@PropertySources({
    ...
    @PropertySource(value="file:${java.io.tmpdir}/DojoManager/app.properties", ignoreResourceNotFound=true)
})
...
public class MailConfiguration implements EnvironmentAware {
    ...
    public JavaMailSenderImpl javaMailSender() {
        ...
        String protocol = propertyResolver.getProperty(PROP_PROTO,String.class,"smtp");
        ...
        sendProperties.setProperty(PROP_SMTP_TRUST, PROP_HOST);
