...
@Table(name = "\"testing\"")
public class Testing implements CustomDomain<Testing> {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "testing_id_seq")
    @SequenceGenerator(name = "testing_id_seq", allocationSize = 1, sequenceName = "testing_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    @JoinColumn(name = "\"tester\"", nullable = true )
    public Student getTester() {
        return tester;
    }
    public void setTester(Student tester){
        this.tester = tester;
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        Testing entity = (Testing)super.clone();
        entity.setId(null);
        return entity;
    }
}