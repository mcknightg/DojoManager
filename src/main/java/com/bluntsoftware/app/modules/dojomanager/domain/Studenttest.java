...
public class Studenttest implements CustomDomain<Studenttest> {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "studenttest_id_seq")
    @SequenceGenerator(name = "studenttest_id_seq", allocationSize = 1, sequenceName = "studenttest_id_seq", initialValue = 1)
    @Column(name = "\"id\"")
    ...
    public Object clone() throws CloneNotSupportedException {
        Studenttest entity = (Studenttest)super.clone();
        entity.setId(null);
        return entity;
    }
}